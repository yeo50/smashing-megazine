<x-app-layout>
    ...
    <h1 class="text-center text-2xl mt-4 font-extrabold"> Create Your Own Post</h1>
    <form action="{{ route('posts.store') }}" method="post" enctype="multipart/form-data"
        ...
        <div>
            ...
            <x-text-input id="title" class="block mt-1 w-full" name="title" type="text" :value="old('title')" required
        ...
        <div>
            ...
            <x-text-area id="description" class="block mt-1 w-full h-60" name="description" :value="old('description')" required
        ...
        <input type="checkbox" value="1" id="" name="is_featured" class="my-2"> Is-featured <br>
        {{-- <x-primary-button class="ms-4" type="submit" class="my-2">
            {{ __('Register') }}
        </x-primary-button> --}}
        <input type="submit" value="Submit" class="p-2 bg-blue-600 shadow rounded-md mx-auto block">
    </form>
</x-app-layout>
